...
PARAM  <- list()
PARAM$experimento  <- "ZZ6917-H2c"
PARAM$exp_input  <- "HT6510-H2c"
...
PARAM$semillas  <- c( 271991, 271997, 271999, 272011, 272029 ) #reemplazar por las propias semillas
...
arch_log  <- paste0( base_dir, "exp/", PARAM$exp_input, "/BO_log_SINHT.txt" )
