...
PARAM  <- list()
PARAM$experimento  <- "ZZv5"
PARAM$exp_input  <- "HTv5"
...
PARAM$semillerio  <- 12   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 271997  # se utiliza para generar el vector de  PARAM$semillerio  semillas
