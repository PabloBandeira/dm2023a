...
PARAM  <- list()
PARAM$experimento  <- "ZZ5910-jug-v3"
...
PARAM$semillas  <- c( 272011) #reemplazar por las propias semillas

PARAM$kaggle$envios_desde  <-  11200
PARAM$kaggle$envios_hasta  <- 1180
PARAM$kaggle$envios_salto  <-   100
